(() => {
    ...
    // Variables - AR Model Viewer
    const modelViewer = document.querySelector("model-viewer");
    const hotspots = document.querySelectorAll(".Hotspot");
    
    // Variables - X-ray Slider
    const divisor = document.querySelector("#divisor");
    const slider = document.querySelector("#slider");
    
    // Variables - Canvas Animation
    ...
    const infoBoxes = [
        ...
        },
        {
            ...
            image: "images/render5.png"
        },
        {
            title: "Ultra Fast Charging",
            text: "Charge your earbuds in 30 minutes or less with our hyper charging technology.",
            image: "images/render7.png"
        }
    ];

    // I'm loading hotspot content for AR model
    function loadInfo() {
    ...
    // I'm showing hotspot info with GSAP
    function showInfo() {
        let selected = document.querySelector(`#${this.slot}`);
        gsap.to(selected, 1, { autoAlpha: 1 });
    }

    // I'm hiding hotspot info with GSAP
    function hideInfo() {
        let selected = document.querySelector(`#${this.slot}`);
